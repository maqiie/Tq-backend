module Admin
  class UsersController < ApplicationController
    ...
    # GET /admin/users
    def index
      @employees = current_user.employees  # Fetch only THIS admin's employees
    ...
    def create
      ...
      @user.admin_id = current_user.id  # ← CRITICAL: Assign to current admin
      ...
      # Only generate OTP secret if OTP is required
    ...
    def destroy
      @user = current_user.employees.find_by(id: params[:id])  # Only delete own employees
      if @user
        if @user.destroy
